...
| **Parameter**                                      | **Value**                                                    |
|----------------------------------------------------|--------------------------------------------------------------|
| name                                               | This parameter is used to provide a name for the configuration that will be created. It can be any string that helps to identify the configuration file.          |
...
| credentials_conf_id                                | This parameter is used to provide the ID of the credentials configuration that will be used by the cluster. The credentials configuration file contains the necessary authentication information to access the resources used by the cluster.                               |
